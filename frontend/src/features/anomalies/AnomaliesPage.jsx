    ...
    <div className="glass-panel widget-card anomalies-workbench">
      ...
      <div className="anomaly-summary-grid">
        ...
        <div className="anomaly-summary-card neutral">
          <span>Info</span><strong>{presentation.stats.info}</strong>
        </div>
        <div className="anomaly-summary-card primary">
          <span>Con azione</span><strong>{presentation.stats.actionable}</strong>
        </div>
      </div>
        ...
        {tabLoading ? (
          ...
          <>
            <div className="anomaly-results-line">
              {presentation.filtered.length} di {anomalyData.length} anomalie visualizzate
            </div>
